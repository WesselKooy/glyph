...
export function PuzzleTile({
  ...
  return (
    <button
      ...
      className={[
        "flex min-h-20 w-full items-center justify-center rounded-md border px-2 py-3 text-center text-sm font-semibold leading-tight shadow-sm transition duration-150",
        ...
        selected
          ? "border-emerald-950 bg-emerald-800 text-white shadow-md ring-2 ring-emerald-950/15"
